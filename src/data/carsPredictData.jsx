...
const carsBrandValues = [
  ...
  { label: "Audi", value: [[0, normal - 0.02]], reverseValue: normal },
  {
    label: "Bentley",
    value: [[0, somewhatFast]],
    reverseValue: somewhatFast - 0.01,
  },
  {
    label: "BMW M-Series",
    value: [
  ...
  { label: "BMW", value: [[0, -0.095]], reverseValue: -0.095 },
  { label: "Bugatti", value: [[0, superCar]], reverseValue: superCar },
  {
    label: "Buick",
    value: [[0, normal]],
    reverseValue: normal - 0.015,
  },
  { label: "BYD", value: [[0, normal]], reverseValue: normal - 0.015 },
  { label: "Cadillac", value: [[0, normal]], reverseValue: normal - 0.015 },
  {
    label: "Chevrolet Corvette",
    value: [[0, reputable]],
    reverseValue: reputable + 0.01,
  },
  { label: "Chevrolet", value: [[0, normal]], reverseValue: normal - 0.015 },
  { label: "Chrysler", value: [[0, normal]], reverseValue: normal - 0.015 },
  { label: "Citroen", value: [[0, fast]], reverseValue: fast + 0.01 },
  { label: "Daewoo", value: [[0, normal]], reverseValue: normal - 0.015 },
  {
    label: "Dodge",
    value: [
      [0, -0.08],
  ...
  { label: "Ferrari", value: [[0, superCar]], reverseValue: superCar },
  { label: "Fiat", value: [[0, fast - 0.005]], reverseValue: fast - 0.015 },
  { label: "Fisker", value: [[0, fast]], reverseValue: fast + 0.01 },
  { label: "Ford", value: [[0, reputable]], reverseValue: reputable + 0.01 },
  { label: "Genesis", value: [[0, normal]], reverseValue: normal - 0.015 },
  { label: "GMC", value: [[0, normal]], reverseValue: normal - 0.015 },
  {
    label: "Harley-Davidson",
    value: [[0, expensiveSportMotorCycle]],
    reverseValue: expensiveSportMotorCycle,
  },
  { label: "Hennessey", value: [[0, superCar]], reverseValue: superCar },
  {
  ...
  { label: "Jaguar", value: [[0, fast]], reverseValue: fast + 0.01 },
  ...
  { label: "Mazda", value: [[0, reliable]], reverseValue: reliable - 0.005 },
  { label: "McLaren", value: [[0, superCar]], reverseValue: superCar },
  { label: "Mercedes-AMG", value: [[0, -0.09]], reverseValue: -0.09 },
  { label: "Mercedes-Benz", value: [[0, -0.0925]], reverseValue: -0.0925 },
  { label: "Mercury", value: [[0, normal]], reverseValue: normal - 0.015 },
  { label: "Mini", value: [[0, normal]], reverseValue: normal - 0.015 },
  {
    label: "Mitsubishi",
    value: [[0, reliable]],
