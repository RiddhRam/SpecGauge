...
- Instagram: [@SpecGauge](https://www.instagram.com/specgauge/)
- Backend Repository: [SpecGauge-Firebase](https://github.com/RiddhRam/SpecGauge-Firebase)
- Web Scraper Repository: [Web-Scraping](https://github.com/RiddhRam/Web-Scraping)
- Short-Form Video Automator: [Short-Form-Video-Automator](https://github.com/RiddhRam/Short-Form-Video-Automator)
...
5. Restore or replace Firebase configuration if you want backend features to work.
